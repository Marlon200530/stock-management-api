...
| Campo | Tipo sugerido | Obrigatório | Default | Descrição |
|---|---|---:|---|---|
| `id` | `uuid` | Sim | `gen_random_uuid()` | Identificador único do utilizador |
...
| `role` | `enum` | Sim | `'STAFF'` | Papel do utilizador no sistema |
| `is_active` | `boolean` | Sim | `true` | Indica se o utilizador está activo |
| `created_at` | `timestamp` | Sim | `now()` | Data de criação |
| `updated_at` | `timestamp` | Sim | `now()` | Data da última actualização |
...
| `status` | `enum` | Sim | `'ACTIVE'` | Estado do produto |
| `created_at` | `timestamp` | Sim | `now()` | Data de criação |
| `updated_at` | `timestamp` | Sim | `now()` | Data da última actualização |
...
| Campo | Tipo sugerido | Obrigatório | Default | Descrição |
|---|---|---:|---|---|
| `id` | `uuid` | Sim | `gen_random_uuid()` | Identificador único da variante |
...
| `attributes` | `text` | Não | `-` | Atributos da variante, como cor, tamanho, modelo, material |
| `is_active` | `boolean` | Sim | `true` | Indica se a variante está activa |
| `created_at` | `timestamp` | Sim | `now()` | Data de criação |
| `updated_at` | `timestamp` | Sim | `now()` | Data da última actualização |
...
| Campo | Tipo sugerido | Obrigatório | Default | Descrição |
|---|---|---:|---|---|
| `id` | `uuid` | Sim | `gen_random_uuid()` | Identificador único do armazém |
...
| `is_active` | `boolean` | Sim | `true` | Indica se o armazém está activo |
| `created_at` | `timestamp` | Sim | `now()` | Data de criação |
| `updated_at` | `timestamp` | Sim | `now()` | Data da última actualização |
...
| Campo | Tipo sugerido | Obrigatório | Default | Descrição |
|---|---|---:|---|---|
| `id` | `uuid` | Sim | `gen_random_uuid()` | Identificador único do nível de stock |
| `variant_id` | `uuid` | Sim | `-` | Variante associada ao stock |
| `warehouse_id` | `uuid` | Sim | `-` | Armazém onde a variante está armazenada |
| `quantity` | `integer` | Sim | `0` | Quantidade actual em stock |
| `created_at` | `timestamp` | Sim | `now()` | Data de criação |
| `updated_at` | `timestamp` | Sim | `now()` | Data da última actualização |
...
| Campo | Tipo sugerido | Obrigatório | Default | Descrição |
|---|---|---:|---|---|
| `id` | `uuid` | Sim | `gen_random_uuid()` | Identificador único do movimento |
...
| `created_at` | `timestamp` | Sim | `now()` | Data em que o movimento foi criado |
